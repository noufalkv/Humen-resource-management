...
public function __construct()
   ...
   public function maping_list()
    {   
        ...
        #pagination ends
        #  
         $data['equip']   =  $this->asset_model->equip_dropdown();
        $data['module'] = "asset";
...
public function maping_form()
 ...
 public function equip_drops(){
       $data['equipment_drop']   =  $this->asset_model->equip_drop();
 }
    ...
    public function maping_update($id = null)
 {
  ...
  if ($this->form_validation->run()) { 
    ...
    redirect("asset/Equipment_maping/maping_update/".$id); 
      ...
      $data['vendorcat']   =  $this->asset_model->get_all($id);
      $data['equip']   =  $this->asset_model->equip_dropdown();
