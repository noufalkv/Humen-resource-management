...
<div class="row">
	...
	<!--<div>
	<!--<a href="<?php //echo base_url("payroll/Payroll/salary_setup_view_report") ; ?>" class="btn btn-xs btn-success">Report For office</a>
	</div>-->
	
	<div>
	<a href="<?php echo base_url("payroll/Payroll/salary_setup_view_report_wps") ; ?>" class="btn btn-xs btn-success">WPS</a>
	</div>
