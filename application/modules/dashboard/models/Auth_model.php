...
return $result = $this->db->select('branch_id,branch_name')->from('branch')->get()->result_array();
}

public function financial_year()
{
	return $result = $this->db->select('financial_year')->from('setting')->where('id',2)->get()->row();
}
