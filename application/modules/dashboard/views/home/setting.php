            ...
            <div class="panel">
                ...
                <?php echo form_open_multipart('dashboard/setting/create','class="form-inner"') ?>
                    <?php echo form_hidden('id',$setting->id) ?>
										<div class="form-group row">                        <label for="title" class="col-xs-3 col-form-label">Financial Year<?php // echo display('application_title') ?> <i class="text-danger">*</i></label>                        <div class="col-xs-9">                            <input name="financial_year" type="text" class="form-control" id="title" placeholder="Financial year" value="<?php echo $setting->financial_year ; ?>">                        </div>                    </div>					
