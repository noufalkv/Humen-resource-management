...
foreach ($transactiondduct as $dduct) {
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6" style="padding-top: 75px;">
                    <div class="panel panel-bd lobidisable">
                ...
                <?php 
                  ...
                  /*  if(isset($bday)){
                        ...
                        foreach($bday as $e){
                         if($i % 2 == 0){
                                echo '<div class="info6">
			<img src="https://i.embed.ly/1/image?url=https%3A%2F%2Fmedia.giphy.com%2Fmedia%2F3ohs7W7ACsSvyY5WoM%2Fgiphy.gif&key=a19fcc184b9711e1b4764040d3dc5c07">
           ...
           <!-- </div>
				...
				<div class="col-sm-6 col-xs-12">
				  ...
				  <div  style="background: white; overflow: auto;min-height: 170px;">  
				 <h4 style="padding-left:20px"><b>Upcoming Birthdays</b></h4>
				 <div class="col-sm-2" style="padding-top:30px">
				 <img src="<?php echo base_url();?>assets/img/torta-150x180.gif" style="width: 76px; height: 85px;" >
			</div>
                              <div class="col-sm-10">  <table class="table table-bordered table-responsive">
                                        <thead>
                                            <tr>
                                                 <th>S.No</th>
                                                <th>Name</th>
										...
										foreach($bday as $e){?>
                                            ...
                                            <tr>
												<td><?php echo $i;?></td>
												<?php $id=$e['employee_id']; ?>
                                                <td><a href="<?php echo base_url("employee/Employees/cv/$id");?>"> <?php echo $e['first_name'];echo "";echo $e['last_name'];?></a></td>
				...
				<div class="col-sm-6 col-xs-12"  >
				<div  style="background: white; overflow: auto;min-height: 170px;">
				 <h4 style="padding-left:20px"><b>File Expiry Notification</b></h4>
				 <div class="col-sm-3" style="padding-top:30px">
				<center> <img src="<?php echo base_url();?>assets/img/Blinking_warning.gif" style="width: 70px;height: 70px;"></center>
			</div>
                              <div class="col-sm-9">  <table class="table table-bordered table-responsive">
                                        <thead>
                                            <tr>
                                                 <th>S.No</th>
                                                <th>File Name</th>
										...
										foreach($expiry as $exp){?>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="<?php echo base_url("category/Filetrack_controller/index");?>" style="color:grey"> <?php echo $exp['file_name'];?></a></td>
                                                <td><span style="color:#f74954;font-weight:bold"><?php echo $exp['file_exp'];?></span></td>
