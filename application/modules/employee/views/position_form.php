            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <?= form_open('employee/Employees/create_position') ?>
                        ...
                        <div class="form-group row">
                            <label for="position_details" class="col-sm-3 col-form-label"><?php echo "Department"; ?></label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="priority" type="text" class="form-control"  placeholder="<?php echo "Priority"; ?>" id="priority" >
                            </div>
                        </div> 
