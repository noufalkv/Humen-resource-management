...
<div class="col-sm-12 col-md-12 rating-block" >
  ...
  <table class="table table-hover" width="100%">
    ...
    <caption  style="text-align: center; font-size: 25px"><?php echo "Files";?></caption>
        ...
        <tr>
          <?php  foreach($files as $filee){?>  
            <td><?php echo $filee->type;?></td>
            <td><a href="<?= base_url('application/modules/category/assets/employee_files/'. $filee->filee_file ); ?>" target="_blank"> Download </a><?php //echo base_url();?></td>
             <?php } ?>
        </tr>
