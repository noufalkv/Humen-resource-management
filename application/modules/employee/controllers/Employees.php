...
//	$data['benifit']  = $this->Employees_model->benifit($id);
	$data['files']  = $this->Employees_model->files($id);
	...
	{   
		...
		$data['designation'] = $this->Employees_model->designation();
			$data['dept'] = $this->Employees_model->department_dropdown();
		...
		$data['branch_options']   = $this->Employees_model->branch_view();
	...
	{  if($this->input->post('branch'))
		...
		if($branch_id != '')
		{
			$data['emp_history']   = $this->Employees_model->emp_list_by_branch($branch_id);
		}
		else
		{
	...
	{ 
	   ...
	   //print_r($benifit_acc_date);exit();
		...
		#-------------------------------#
		 ...
		 {
			$branch_id_ = $this->input->post('branch_id') ;
		 }
		 else
		 {
			$branch_id_ = $this->session->userdata('branch_id');
		 }
		...
		if ($this->form_validation->run() === true) {
			...
			$postData = [
				...
				'pf_status'               => $this->input->post('pf_status',true) ,
				'pf_uan'                  => $this->input->post('pf_uan',true) ,
				'esi_status'              => $this->input->post('esi_status',true) ,
				'esi_ip_number'           => $this->input->post('esi_ip_number',true) ,
				'permanent_status'        => $this->input->post('permanent_status',true),
				'adhar_card_no'           => $this->input->post('adhar_card_no',true),
			...
			$data_new_post['experience'] = [
			'employee_id' 	          => $employee_id,
			'company_name' => $this->input->post('company_name',true),
			'duration' => $this->input->post('duration',true),
			'designation' => $this->input->post('designation',true),
			'salary' => $this->input->post('salary',true),
			'esi_pf_welfare_scheme_card_no' => $this->input->post('esi_pf_welfare_scheme_card_no',true),
			'pan_card_no' => $this->input->post('pan_card_no',true),
			'reason_of_leaving' => $this->input->post('reason_of_leaving',true),
			'other_work_experience' => $this->input->post('other_work_experience',true),
			'training_attended' => $this->input->post('training_attended',true)
			];
			
			
			$data_new_post['education'] = [
			'employee_id' 	          => $employee_id,
			'tenth_course' => $this->input->post('tenth_course',true),
			'tenth_institution' => $this->input->post('tenth_institution',true),
			'tenth_year_of_passing' => $this->input->post('tenth_year_of_passing',true),
			'plus_two_predeeree_dipl_course' => $this->input->post('plus_two_course',true),
			'plus_two_predeeree_dipl_institution' => $this->input->post('plus_two_institution',true),
			'plus_two_predeeree_dipl_year_of_passing' => $this->input->post('plus_two_year_of_passing',true),
			'graduation_course' => $this->input->post('graduation_course',true),
			'graduation_institution' => $this->input->post('graduation_institution',true),
			'graduation_year_of_passing' => $this->input->post('graduation_year_of_passing',true),
			'post_graduation_course' => $this->input->post('post_graduation_course',true),
			'post_graduation_institution' => $this->input->post('post_graduation_institution',true),
			'post_graduation_year_of_passing' => $this->input->post('post_graduation_year_of_passing',true),
			'aq_course' => $this->input->post('aq_course',true),
			'aq_institution' => $this->input->post('aq_institution',true),
			'aq_year_of_passing' => $this->input->post('aq_year_of_passing',true),
			'computer_knowledge_course' => $this->input->post('ck_course',true),
			'computer_knowledge_institution' => $this->input->post('ck_institution',true),
			'computer_knowledge_year_of_passing' => $this->input->post('ck_year_of_passing',true),
			...
			$data_new_post['nominee'] = array();
			$data_new_post['nominee']['nominee_name'] =  $this->input->post('nominee_name',true);
			$data_new_post['nominee']['nominee_relation'] =  $this->input->post('nominee_relation',true) ;
			$data_new_post['nominee']['nominee_dob'] =  $this->input->post('nominee_dob',true) ;
			$data_new_post['nominee']['nominee_occupation'] =  $this->input->post('nominee_occupation',true) ;
			$data_new_post['employee_id'] = $employee_id ;
			$data_new_post['gross'] = [			
			'employee_id' => $employee_id ,
			'rate' => $this->input->post('rate',true) 
			];
			...
			if($this->db->insert('employee_history', $postData)){
				$this->Employees_model->insert_new_post($data_new_post);
				$this->Employees_model->insert_paid_leave($employee_id,$this->session->userdata('financial_year'));				
	...
	{ 
		...
		if ($this->form_validation->run() === true) {
			...
			$data_new_post['emp_exp_id'] = $this->input->post('emp_exp_id',true);
			$data_new_post['experience'] = [
			'employee_id' 	          => $this->input->post('employee_id',true),
			'company_name' => $this->input->post('company_name',true),
			'duration' => $this->input->post('duration',true),
			...
			$data_new_post['emp_edu_id'] = $this->input->post('emp_edu_id',true);
			$data_new_post['education'] = [
			'employee_id' 	          => $this->input->post('employee_id',true),
			'tenth_course' => $this->input->post('tenth_course',true),
			'tenth_institution' => $this->input->post('tenth_institution',true),
			...
			$data_new_post['emp_bank_id'] = $this->input->post('emp_bank_id',true);
			$data_new_post['bank'] = [
			"employee_id" => $this->input->post('employee_id',true),
			"bank_name" => $this->input->post('bank_name',true),
			"ifsc" => $this->input->post('ifsc',true),
			...
			$data_new_post['nominee'] = array();
			$data_new_post['nominee']['emp_nom_id'] =  $this->input->post('emp_nom_id',true);
			$data_new_post['nominee']['nominee_name'] =  $this->input->post('nominee_name',true);
			$data_new_post['nominee']['nominee_relation'] =  $this->input->post('nominee_relation',true) ;
			$data_new_post['nominee']['nominee_dob'] =  $this->input->post('nominee_dob',true) ;
			$data_new_post['nominee']['nominee_occupation'] =  $this->input->post('nominee_occupation',true) ;
			$data_new_post['employee_id'] = $this->input->post('employee_id',true) ;
			...
			if ($this->Employees_model->update_employee($postData)) { 
				$this->Employees_model->update_employee_new($data_new_post);
			...
			$data['data_new'] = $this->Employees_model->employee_updateForm_new($id);
			$data['dept'] = $this->Employees_model->department_dropdown();
			$data['module'] = "employee";
	...
	public function deptList(){
		...
		$datas = $this->db->select('*')->from('position')->where('dept_id',$dept_id)->get()->result_array();		
		$info_arr = array();
