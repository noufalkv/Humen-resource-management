...
class MyUpload
{
    ...
    function do_upload($upload_path = null, $field_name = null,$employee = null) {
        if (empty($_FILES[$field_name]['name'])) {
            ...
            //folder upload
            if($employee !=  null)
            $file_path = $upload_path . $employee . "/";
            else
            ...
            $config = [
                ...
                'allowed_types' => 'pdf|docx|xlsx|jpg|png|jpeg|gif',
                'max_filename'  => 7,
                'overwrite'     => fales,
                'maintain_ratio' => true,
                'encrypt_name'  => false,
            ...
            if (!$ci->upload->do_upload($field_name)) {
                ...
                $file = $ci->upload->data();
                return $employee1.$file['file_name'];
            }
        }
    }  
