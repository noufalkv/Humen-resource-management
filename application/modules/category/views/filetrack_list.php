...
<div class="panel panel-default" style="float: left;width: 100%;">
               ...
               <div class="panel-body" style="padding: 15px;float: left;">	
				<?php echo form_open('category/Filetrack_controller/index',array('class' => 'form-inline', 'id' => 'validate'));?>		
                                  ...
                                  <td><?php echo $row->file_exp; ?></td> 
                                   ...
                                   <td><?php echo $row->file_status; ?></td> 
                                      <td class="center">
                                        ...
                                        <a href="<?php echo base_url("category/Filetrack_controller/filetrack_form/$row->file_id") ?>" class="btn btn-xs btn-success"><i class="fa fa-pencil"></i></a>
                                  
                                    
                                     
                                        <a href="<?php echo base_url("category/Filetrack_controller/delete_filetrack/$row->file_id") ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?>') "><i class="fa fa-close"></i></a>
