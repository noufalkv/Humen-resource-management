   <div class="row">
        <div class="col-sm-12 col-md-12">
            <div class="panel">
                ...
                <?= form_open_multipart('category/filetrack_controller/filetrack_form') ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                                    <input name="filetrack_file" class="form-control" type="file"  id="filetrack_file" value="<?php echo (!empty($filetrack->filee_file)?$filetrack->filee_file:null) ?>" >
                        </div>
                        <div class="col-sm-4">
                                    <input  class="form-control" type="text"  name="filetrack_filesss" value="<?php echo (!empty($filetrack->filee_file)?$filetrack->filee_file:null) ?>" readonly >
                        </div>
                    </div> 
